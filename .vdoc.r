...
#
# Getting the size of the neurons in the validation
data_neurons <- read.csv(here("./data/neuron_size.csv")) %>%
  filter(X == "Medial Cortex_Tube_002_003.fcs")
neuron_size <- log10(as.numeric(data_neurons$cells.Neurons...Geometric.Mean..FSC.A.))
#
#
#
#
