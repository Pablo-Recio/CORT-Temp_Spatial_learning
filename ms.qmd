...
if(refit){
  m_SEM <- brm(
    bf(slope_mean | se(slope_sd, sigma = FALSE) ~ mit_density + mit_potential + DNAdamage + peroxidation + (1|clutch) + (1|q|obs)) +
    bf(DNAdamage | se(vec, sigma = FALSE) ~ ROS + (1|clutch)+ (1|p|obs)) +
    bf(peroxidation | se(vec, sigma = FALSE) ~ ROS + (1|clutch) + (1|p|obs)) +
