...
There are a total of  `r total_individuals`, and `r total_clutches` clutches in the database. The average number of individuals per clutch is `r mean(individuals_per_clutch)`, with a minimum of `r min(individuals_per_clutch)` individuals per clutch (`r sum(individuals_per_clutch$individual_count == max(individuals_per_clutch$individual_count))` clutches) and a maximum of `r sum(individuals_per_clutch$individual_count == min(individuals_per_clutch$individual_count))` ( clutches).
