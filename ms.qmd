...
Immediately after completing the tests, we quantified mitochondrial physiology in the brains of lizards. We euthanized lizards via intraperitoneal injection of 10 mg/kg of a 10 mg/mL alfaxan solution (a potent anesthetic), followed by decapitation. Before decapitation, we evaluated lizard righting responses and the pinching reflexes in one of the front limbs.  
...
Mean estimated clutch effects in the univariate models ranged from 0.073 to 0.192 (see Table S3). Mean estimated effect of lizard identity on the learning slopes was `r format_dec(mean(m_def_learn$sd_lizard_id__Intercept), 3)` (90% CI = [`r format_dec(quantile(m_def_learn$sd_lizard_id__Intercept, 0.05), 3)`; `r format_dec(quantile(m_def_learn$sd_lizard_id__Intercept, 0.95), 3)`]).      
...
for(x in var){
  ...
  q5 <- format_dec(quantile(df$sd_clutch__Intercept, 0.05), 3)
  q95 <- format_dec(quantile(df$sd_clutch__Intercept, 0.95), 3)
...
Table S6.  Preliminary results of the models testing for Metabolic capacity.
...
Table S7. Preliminary results of the models testing for ROS.
...
Table S8. Preliminary results of the models testing for DNA damage.
...
Table S9. Preliminary results of the models testing for lipid peroxidation.
...
Table S10. Preliminary results of the models testing for learning.
