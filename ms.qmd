...
annotate("text", x = Inf, y = Inf, label = r_errors_text, 
           hjust = 1.28, vjust = 1.95, size = 4.5, color = "#8D0001")
#
...
ggsave("./output/figures/fig_ROS_learning_2.png", plot=plot_ROS_errors, width = 15, height = 10, units = "cm", dpi = 600)
```
